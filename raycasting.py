...
class RayCasting:
    ...
    def cast_ray(x, y, map_x, map_y, angle, max_length, game):
        ...
        hor_depth = (hor_y - y) / sin_angle if sin_angle != 0 else 0
        ...
        while (hor_depth + hor_depth_delta < max_length):
        ...
        vert_depth = (vert_x - x) / cos_angle if cos_angle != 0 else 0
        ...
        while (vert_depth + vert_depth_delta < max_length):
